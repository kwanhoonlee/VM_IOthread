...
plt_path = results_path + 'plt/bandwidth/' + model  + '_'
pred_path = results_path + 'pred/bandwidth/'+ model + '_'
...
for i in range(len(x_list)):
    ...
    func.save_prediction(inverted_y, inverted_yhat, pred_path + str(i) + '.csv', x_col, inverted_x)
